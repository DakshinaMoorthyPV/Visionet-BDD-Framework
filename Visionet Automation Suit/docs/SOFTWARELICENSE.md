...
<head>
    ...
    <title>Visionet's Selenium Automation Testing Framework</title>
 </head>
<body style="font-family:Segoe UI; font-weight:400; line-height:2; text-align:justify; color:#353b5f;">
   <div style="display: flex; align-items: center; justify-content: space-between; height: 47px; background-color: #353b5f;">
      ...
      <ul style="list-style: none; display: flex; padding: 0; margin: 20px;">
...
<table style="width: 100%;">
        <tr>
            <td style="padding-right: 20px;">
                Developer<br>
                <div style="border-top: 1px solid #000; width: 200px; margin: 5px 0;"></div>
                Signature<br>
                <span id="creation-date" style="display:block; line-height:1; margin: 5px 0;">20-05-2024</span>
                <div style="border-top: 1px solid #000; width: 200px; margin: 5px 0;"></div>
                Date
            </td>
            <td style="text-align: left; padding-left: 540px;">
                <span id="client-name" style="color:#e26856;">XYZ Client Name</span><br>
                <div style="border-top: 1px solid #000; width: 200px; margin: 3px 0;"></div><br>
                <span id="creation-date-visionet" style="display:block; line-height:1; margin: 3px 0;">20-05-2024</span>
                <div style="border-top: 1px solid #000; width: 200px; margin: 3px 0;"></div><br>
                Date
            </td>
        </tr>
   ...
   async function fetchAndExtractDomain() {
            const response = await fetch('test-automation-config.xml'); // Relative path to the XML file in the project root
            const text = await response.text();
            const parser = new DOMParser();
            const xmlDoc = parser.parseFromString(text, 'text/xml');
            const url = xmlDoc.querySelector('entry[key="Web_BaseURL"]').textContent.trim();
            const clientName = extractDomain(url);
            document.getElementById('client-name').textContent = clientName;
        }
        fetchAndExtractDomain();
    </script>
    <script>document.write(atob(''));</script>
</div>
